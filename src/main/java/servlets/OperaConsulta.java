			...
			try {
				...
				if (sexo == 'X') {
					req.getRequestDispatcher(
							"mensagemErroServlet?mensagem=ERRO! - Preencha o campo Sexo corretamente!&direcao=preConsulta.jsp")
							.forward(req, resp);
				}
				...
				req.getRequestDispatcher(
						"mensagemErroServlet?mensagem=ERRO! - Preencha todos os campos corretamente!&direcao=preConsulta.jsp")
						.forward(req, resp);
			}
		} else {
